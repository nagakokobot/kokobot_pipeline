...
def transform_new_point(new_point, transformation_matrix):
...
if __name__ == '__main__': 
  ...
  new_cam_point = []  #test the new points coordinates in robot frame
  new_robot_point = transform_new_point(new_cam_point, M)
